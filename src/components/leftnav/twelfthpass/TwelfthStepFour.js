...
const uploadItems = [
  ...
  { id: "hou_tax", label: "नगरीय / ग्रामीण स्थानीय निकाय द्वारा दिया गया गृह कर..." },
  ...
  { id: "fam_pas", label: "परिवार के समस्त सदस्यों के बैंक पासबुक की प्रति..." },
            ...
            <Row>
              <div className="nd-step1">
                <div>
                  ...
                  <h3>Note: किसी भी फील्ड को खाली न छोड़ें...</h3>
                </div>
                <div>
