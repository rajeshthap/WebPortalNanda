    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} size="lg">
        <Modal.Header closeButton>
          <Modal.Title className="nd-step1">
            <h3>Step Two Details</h3>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <div className="table-responsive">
              <table className="table table-bordered">
                ...
                <tbody>
                  {[
                    // { id: 1, label: "पिता का नाम", name: "fath_name" },
                    {
                      id: 2,
                      label: "पिता का मनरेगा जॉब कार्ड नंबर",
                      name: "mnrega_fath",
                    },
                    {
                      id: 3,
                      label: "पिता के मनरेगा कार्य दिवस",
                      name: "mnrega_fath_days",
                    },
                    {
                      id: 4,
                    ...
                    // { id: 5, label: "माता का नाम", name: "moth_name" },
                    {
                      id: 6,
                      label: "माता का मनरेगा जॉब कार्ड नंबर",
                      name: "mnrega_moth",
                    },
                    {
                      id: 7,
                      label: "माता के मनरेगा कार्य दिवस",
                      name: "mnrega_moth_days",
                    },
                    {
                      id: 8,
           ...
           <div className=" nd-update-detials">
                        <Button
                          className="nd-primary-dawnload text-right"
