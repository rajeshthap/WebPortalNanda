          ...
          <div className="main">
            ...
            <div className="box-container">
              <div className="nd-district-heading">
                <h1>List of Application Rejected by CDPO | Praroop 2</h1>
              </div>
              <div className="pro-list-data">
                <h2>
                  This list shows applications received till date (This list is
                  not to be used for presenting before committee as data in this
                  list will fluctuate when new forms are approved by CDPO or
                  Returned by DPO to CDPO)
                </h2>
              </div>
...
export default RejectedCDPO2023;
