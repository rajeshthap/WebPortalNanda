        ...
        <div className="main-container">
          ...
          <div className="main">
            ...
            <div className="nd-district-heading">
                <h1>Praroop 1 District Samiti Format Part II</h1>
              </div>
              <div className="pro-list-data">
                <h2>Nanda Gaura District Comittee Format Report</h2>
                <h3>This list shows applications received Between 20-Jan-2024 to 31-Jan-2024</h3>
              </div>
              <Row>
                ...
                <Table className="district-thead" striped bordered hover>
                  <thead>
                    <tr>
                      ...
                      <th rowSpan="2">Affidavit of Not more than two girls benefitted with scheme, attached(Y/N)</th>
                    ...
                    <tr>
                      ...
                      <th>Certificate of Institutial Delivery Attached(Y./N)</th>
                      <th>DOB</th>
                      <th>Name</th>
                      <th>Pan Card No</th>
                      <th>Name</th>
...
export default ExcelPraroopTwo;
