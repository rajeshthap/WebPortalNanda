          ...
          <div className="main">
            ...
            <div className="box-container">
              <div className="nd-district-heading">
                <h1>List of Application Approved by CDPO | Praroop 1</h1>
              </div>
              <div className="pro-list-data">
                <h2>
                This list shows applications received till date
                </h2>
              </div>
              <Row>
                ...
                <Table className="district-thead" striped bordered hover>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className="td-p">
                          <Button className="view-app-cdpo">
                            <span class="badge  rounded-pill text-dark-white d-inline-block nd-cdpo-district nd-btn-app">
                            Remove from Accepted{" "}
                              <IoMdCloseCircle className="pro-form-app" />
                            </span>
                          </Button>
                        </div>
                      </td>
...
export default ApprovalApprovedCDPO;
