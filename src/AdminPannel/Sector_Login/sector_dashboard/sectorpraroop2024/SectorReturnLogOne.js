          ...
          <div className="main">
            ...
            <div className="box-container">
              <div className="nd-sector-heading">
                <h1>Sector-wise Applications Recieved(Praroop 1)</h1>
              </div>
              <div className="pro-list-data">
                <h2>Nanda Gaura Real-time Application Report for New Born Girl Child</h2>
              </div>
               <Col lg={6} md={6} sm={12}>
                                <div class="search-container">
                                  <form>
                                    <input
                                      ...
                                      aria-label="Search"
                                    />
                                    <label className="search-btn-sector" for="searchleft">
...
export default SectorReturnLogOne;